  ...
  <header :class="[hide ? 'max-sm:h-12' : '']"
    ...
    <footer class="absolute bottom-0 w-full h-1/3 bg-indigo-50 left-0 p-4">
      <div class="flex items-center gap-4">
        ...
        <span><a href="https://github.com/fk0u" class="no-underline" target="_blank">Github</a></span>
      </div>
      <div class="flex items-center gap-4 mt-2">
        ...
        <span><a href="https://www.instagram.com/fk.k0u" class="no-underline" target="_blank">Instagram</a></span>
      </div>
      <div class="flex items-center gap-4 mt-2">
